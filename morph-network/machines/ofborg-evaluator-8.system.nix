  ...
  imports = [
    ...
    ({
      swapDevices = [
        ...
        {
          device = "/dev/disk/by-id/ata-MTFDDAV240TDU_203329FD8499-part2";
        }
      ...
      fileSystems = {
        ...
        "/" = {
          device = "/dev/disk/by-id/ata-MTFDDAV240TDU_203329FD8499-part3";
          fsType = "ext4";
      ...
      boot.loader.grub.devices = [ "/dev/disk/by-id/ata-MTFDDAV240TDU_203329FD8499" ];
    })
    ({ networking.hostId = "037fe9e3"; }
    )
    ({ modulesPath, ... }: {
      networking.hostName = "ofborg-evaluator-8";
      ...
      systemd.network.networks."30-enp65s0f0" = {
        matchConfig = {
          Name = "enp65s0f0";
          PermanentMACAddress = "40:a6:b7:4a:96:40";
        };
      ...
      systemd.network.networks."30-enp65s0f1" = {
        matchConfig = {
          Name = "enp65s0f1";
          PermanentMACAddress = "40:a6:b7:4a:96:41";
        };
        networkConfig.Bond = "bond0";
      };
      ...
      systemd.network.networks."40-bond0".addresses = [
        {
          addressConfig.Address = "147.75.61.51/31";
        }
        {
      ...
      systemd.network.networks."40-bond0".routes = [
        {
          routeConfig.Gateway = "147.75.61.50";
        }
        {
